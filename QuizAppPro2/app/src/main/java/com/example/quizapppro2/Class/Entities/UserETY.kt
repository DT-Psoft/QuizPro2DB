...
@Entity(tableName = "user",indices = [Index(value = ["id_user"], unique = true)])
data class UserETY (
    @field:ColumnInfo(name = "user_name") var user_name: String,
    @field:ColumnInfo(name = "password") var password: Int,
    @field:ColumnInfo(name = "is_logged") var is_logged: Int = 0,
